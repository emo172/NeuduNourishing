package com.neusoft.yyzx.utils;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\Job\\neusoft\\YYZX\\src\\main\\java");
        gc.setAuthor("WCT");// 设置作者名字
        ...
        dsc.setPassword("13098459921wct");
        ...
        // ⼆、模块配置
        pc.setParent("com.neusoft.yyzx")
                .setEntity("com/neusoft/yyzx/pojo")
                .setMapper("mapper")
                .setService("service")
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "D:\\Job\\neusoft\\YYZX\\src\\main\\resources\\mapper" + pc.getModuleName()
